...
func (suite *ServiceTestSuite) SetupTest() {
	...
	suite.svc = newService(
		suite.mockStore, suite.resolver, suite.mockOUService, &fakeTransactioner{}, nil, nil, nil, false,
	).(*service)
}
...
func (suite *ServiceTestSuite) TestResolveEditability_EditableWhenInGrant() {
	...
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{OwningOUID: "owner1", Stage: StageShare, TargetScope: TargetScopeAllRoots,
...
func (suite *ServiceTestSuite) TestListShareGrants() {
	expected := []ShareGrant{{ID: "grant1", ResourceType: testResourceType, ResourceID: "role1"}}
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return(expected, nil)

	grants, svcErr := suite.svc.ListShareGrants(context.Background(), testResourceType, "role1")

	suite.Nil(svcErr)
	suite.Equal(expected, grants)
}

func (suite *ServiceTestSuite) TestListShareGrants_StoreError() {
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return(nil, errBoom)

	_, svcErr := suite.svc.ListShareGrants(context.Background(), testResourceType, "role1")
...
func (suite *ServiceTestSuite) TestShare_AllRoots() {
	suite.svc.RegisterResourceType(&fakeDeclaration{resourceType: testResourceType})
	suite.mockStore.On("CreateGrant", mock.Anything, mock.MatchedBy(func(g ShareGrant) bool {
...
func (suite *ServiceTestSuite) TestShare_SelectedRoots_NonRootOwner_ForeignRoot_AllowedWhenConfigEnabled() {
	suite.svc = newService(suite.mockStore, suite.resolver, suite.mockOUService, &fakeTransactioner{},
...
// (Stage: share, per the §5.16 fix) is exported with ActingOUID == the owner, not derived from
// TargetOUID — Stage takes priority over TargetScope when deriving ActingOUID.
...
func (suite *ServiceTestSuite) TestShare_ChildrenMode_AllChildren_AnchorsOnActingOU() {
	...
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{existingShareGrant}, nil)
	suite.mockStore.On("CreateGrant", mock.Anything, mock.MatchedBy(func(g ShareGrant) bool {
...
func (suite *ServiceTestSuite) TestShare_ChildrenMode_ChainedDelegation_IntermediateOUCanShareFurther() {
	suite.svc.RegisterResourceType(&fakeDeclaration{resourceType: testResourceType})
	suite.resolver.ancestors["child1"] = []string{"root1"}
	shareGrant := ShareGrant{ID: "share1", ResourceType: testResourceType, ResourceID: "role1",
		OwningOUID: testOwningOU, Stage: StageShare, TargetScope: TargetScopeRoot, TargetOUID: "root1"}
	reshareToChild := ShareGrant{ID: "reshare1", ResourceType: testResourceType, ResourceID: "role1",
		OwningOUID: testOwningOU, Stage: StageReshare, TargetScope: TargetScopeOU, TargetOUID: "child1",
		ParentGrantID: "share1"}
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{shareGrant, reshareToChild}, nil)
...
func (suite *ServiceTestSuite) TestShare_ChildrenMode_SelectedOUs_RejectsGrandchildTarget() {
	suite.svc.RegisterResourceType(&fakeDeclaration{resourceType: testResourceType})
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{Stage: StageShare, TargetScope: TargetScopeAllRoots}}, nil)
...
func (suite *ServiceTestSuite) TestShare_ChildrenMode_SelectedOUs_Success() {
	suite.svc.RegisterResourceType(&fakeDeclaration{resourceType: testResourceType})
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{ID: "grant1", Stage: StageShare, TargetScope: TargetScopeAllRoots}}, nil)
	suite.resolver.ancestors["child1"] = []string{"root1"}
	suite.mockStore.On("CreateGrant", mock.Anything, mock.MatchedBy(func(g ShareGrant) bool {
...
func (suite *ServiceTestSuite) TestShare_Reshare_DefaultEditableFields_InheritsActingOUsOwnSet() {
	...
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{OwningOUID: testOwningOU, Stage: StageShare, TargetScope: TargetScopeAllRoots,
...
func (suite *ServiceTestSuite) TestResolveEditableFields_PrefersDeepestGrantOverBroaderUpstreamOne() {
	...
	broadUpstreamGrant := ShareGrant{ID: "broad", OwningOUID: testOwningOU, Stage: StageShare,
		TargetScope: TargetScopeAllChildren, TargetOUID: testOwningOU,
		EditableFields: []string{"assignments.user", "assignments.group"}}
	narrowerReshareFromX := ShareGrant{ID: "narrow", OwningOUID: testOwningOU, Stage: StageReshare,
		TargetScope: TargetScopeAllChildren, TargetOUID: "x", ParentGrantID: "broad",
		EditableFields: []string{"assignments.user"}}
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{broadUpstreamGrant, narrowerReshareFromX}, nil)
...
func (suite *ServiceTestSuite) TestResolveEditableFields_ExplicitOUReshareBeatsBroaderAllChildrenGrant() {
	...
	broadUpstreamGrant := ShareGrant{ID: "broad", OwningOUID: testOwningOU, Stage: StageShare,
		TargetScope: TargetScopeAllChildren, TargetOUID: testOwningOU,
		EditableFields: []string{"assignments.user", "assignments.group"}}
	explicitReshareFromXToY := ShareGrant{ID: "narrow", OwningOUID: testOwningOU, Stage: StageReshare,
		TargetScope: TargetScopeOU, TargetOUID: "y", ParentGrantID: "broad",
		EditableFields: []string{"assignments.group"}}
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{broadUpstreamGrant, explicitReshareFromXToY}, nil)
...
func (suite *ServiceTestSuite) TestIsShared_OwnerAlwaysVisibleEvenWithNoGrants() {
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{OwningOUID: testOwningOU, Stage: StageReshare, TargetScope: TargetScopeAllChildren,
...
func (suite *ServiceTestSuite) TestIsShared_RootVisibleViaAllRoots() {
	suite.mockStore.On("ListGrantsForResource", mock.Anything, testResourceType, "role1").
		Return([]ShareGrant{{OwningOUID: testOwningOU, Stage: StageShare, TargetScope: TargetScopeAllRoots}}, nil)
...
func (suite *ServiceTestSuite) TestIsShared_ResolverError() {
	suite.svc = newService(suite.mockStore, &erroringResolver{}, suite.mockOUService, &fakeTransactioner{},
...
func (suite *ServiceTestSuite) TestUnshare_GrantNotFound() {
	suite.mockStore.On("GetGrant", mock.Anything, "missing").Return(ShareGrant{}, ErrGrantNotFound)
...
func (suite *ServiceTestSuite) TestUnshare_SingleOU_FiresHookOnceAndDeletes() {
	...
	grant := ShareGrant{ID: "grant1", ResourceType: testResourceType, ResourceID: "role1",
	...
	suite.mockStore.On("ListChildGrants", mock.Anything, "grant1").Return([]ShareGrant{}, nil)
...
func (suite *ServiceTestSuite) TestUnshare_ProcessesChildGrantsBeforeParent() {
	...
	parent := ShareGrant{ID: "parent", ResourceType: testResourceType, ResourceID: "role1",
		Stage: StageShare, TargetScope: TargetScopeRoot, TargetOUID: "root1"}
	child := ShareGrant{ID: "child", ResourceType: testResourceType, ResourceID: "role1",
	...
	suite.mockStore.On("ListChildGrants", mock.Anything, "parent").Return([]ShareGrant{child}, nil)
	suite.mockStore.On("ListChildGrants", mock.Anything, "child").Return([]ShareGrant{}, nil)
